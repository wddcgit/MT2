...
uses
  ...
  Vcl.StdCtrls, Vcl.ExtCtrls, AdvGlowButton, AdvEdit, W7Classes, W7Bars;
...
begin
   pnlSearchFOr.Visible:= cbCriteria.ItemIndex > 1;
end;
    ...
    try
      ...
      With dmMT2.qMT_Search do
         try
           ...
           0:  begin //last 20
                  SQL.Text:= 'SELECT TOP 20  a.logid,a.caller,a.logdate,b.problem,b.notes,b.categoryid,b.closed,a.customerid';
                  SQL.Add('FROM [MultiTracking].dbo.tblCustomerLogInfo a');
                  SQL.Add('LEFT OUTER JOIN [MultiTracking].dbo.tblCustomerLog b ON (a.LogId = b.logid)');
